	...
	required_providers {
			...
			region = "us-east-1"
				...
				resource "aws_lb_target_group_attachment" "webAppInstance1" {
				  target_group_arn = aws_lb_target_group.instances.arn
				  target_id        = aws_instance.webAppInstance1.id
				  port             = 8080
				}
				
				resource "aws_lb_target_group_attachment" "webAppInstance2" {
				  target_group_arn = aws_lb_target_group.instances.arn
				  target_id        = aws_instance.webAppInstance2.id
				  port             = 8080
				}
